...
class Links:
    ...
    def top_directors(self, n):
        ...
        list_of_directors = [i[1] for i in self.get_imdb(movieIDs[1:30], ['directors'])]
    ...
    def most_expensive(self, n):
        ...
        movieIDs = self.get_list_of_links_field(0)
        list_of_budgets = [i for i in self.get_imdb(movieIDs[1:30], ['productionBudget'])]
    ...
    def most_profitable(self, n):
        ...
        splited_rows = [i.split(',') for i in rows2]
        movieIDs = self.get_list_of_links_field(0)
        list_of_budgets = [i for i in self.get_imdb(movieIDs[1:30], ['productionBudget', 'lifetimeGross'])]
    ...
    def longest(self, n):
        ...
        splited_rows = [i.split(',') for i in rows2]
        movieIDs = self.get_list_of_links_field(0)
        list_of_budgets = [i for i in self.get_imdb(movieIDs[1:30], ['runtime'])]
    ...
    def top_cost_per_minute(self, n):
        ...
        splited_rows = [i.split(',') for i in rows2]
        movieIDs = self.get_list_of_links_field(0)
        list_of_budgets = [i for i in self.get_imdb(movieIDs[1:30], ['productionBudget', 'runtime'])]
    ...
    def top_winners(self, n):
        ...
        splited_rows = [i.split(',') for i in rows2]
        movieIDs = self.get_list_of_links_field(0)
        list_of_budgets = [i for i in self.get_imdb(movieIDs[1:30], ['wins'])]
